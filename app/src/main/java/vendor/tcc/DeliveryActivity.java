...
public class DeliveryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        store_id = SharedPref.getString(DeliveryActivity.this, BaseURL.STORE_ID);
        preferences = getSharedPreferences("lan", MODE_PRIVATE);

        tv_date = (TextView) findViewById(R.id.tv_deli_date);
        tv_time = (TextView) findViewById(R.id.tv_deli_fromtime);
        tv_add_adress = (RelativeLayout) findViewById(R.id.tv_deli_add_address);
        tv_total = (TextView) findViewById(R.id.tv_deli_total);
        tv_item = (TextView) findViewById(R.id.tv_deli_item);
        btn_checkout = (RelativeLayout) findViewById(R.id.btn_deli_checkout);
        rv_address = (RecyclerView) findViewById(R.id.rv_deli_address);
        rv_address.setLayoutManager(new LinearLayoutManager(DeliveryActivity.this));
        //tv_socity = (TextView) view.findViewById(R.id.tv_deli_socity);
        //et_address = (EditText) view.findViewById(R.id.et_deli_address);

        db_cart = new DatabaseHandler(DeliveryActivity.this);
        tv_total.setText(db_cart.getTotalAmount());
        tv_item.setText("" + db_cart.getCartCount());

        // get session user data
        sessionManagement = new Session_management(DeliveryActivity.this);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_deli_checkout) {
            ...
            if (TextUtils.isEmpty(getdate)) {
                Toast.makeText(DeliveryActivity.this, getResources().getString(R.string.please_select_date), Toast.LENGTH_SHORT).show();
            } else {
                Intent intent = new  Intent(DeliveryActivity.this, ViewTimeActivity.class);
...
*/
        if (!delivery_address_modelList.isEmpty()) {
            if (adapter.ischeckd()) {
                ...
                Toast.makeText(DeliveryActivity.this, getResources().getString(R.string.please_select_address), Toast.LENGTH_SHORT).show();
                cancel = true;
            }
        } else {
            Toast.makeText(DeliveryActivity.this, getResources().getString(R.string.please_add_address), Toast.LENGTH_SHORT).show();
            cancel = true;
        }
        ...
        if (!cancel) {
            ...
            Intent intent  = new Intent(DeliveryActivity.this, DeliveryPaymentDetailActivity.class);
            intent .putExtra("getdate", getdate);
            intent.putExtra("time", gettime);
            intent.putExtra("location_id", location_id);
            intent.putExtra("address", address);
            intent.putExtra("deli_charges", deli_charges);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    if (DeliveryActivity.this != null) {
                        Toast.makeText(DeliveryActivity.this, getResources().getString(R.string.connection_time_out), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    public void onResume() {
        super.onResume();
        // register reciver
        registerReceiver(mCart, new IntentFilter("Grocery_delivery_charge"));
    }
    ...
    private BroadcastReceiver mCart = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (type.contentEquals("update")) {
                ...
                tv_total.setText("" + db_cart.getTotalAmount() + " + " + deli_charges + " = "  + total+ getResources().getString(R.string.currency));
            }
        }
    };
