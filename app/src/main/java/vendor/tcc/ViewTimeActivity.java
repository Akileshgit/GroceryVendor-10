...
public class ViewTimeActivity extends AppCompatActivity {
    ...
    private String TAG = "ViewTimeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManagement = new Session_management(ViewTimeActivity.this);

        rv_time = (RecyclerView) findViewById(R.id.rv_times);
        rv_time.setLayoutManager(new LinearLayoutManager(ViewTimeActivity.this));
        ...
        rv_time.addOnItemTouchListener(new RecyclerTouchListener(ViewTimeActivity.this, rv_time, new RecyclerTouchListener.OnItemClickListener() {
            @Override
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    Toast.makeText(ViewTimeActivity.this, getResources().getString(R.string.connection_time_out), Toast.LENGTH_SHORT).show();
                }
            }
        });
